...
mixin _$UserProfile {
  ...
  EthnicityEnum get ethnicity => throw _privateConstructorUsedError;
...
class _$_UserProfile extends _UserProfile {
  ...
  @override
  final EthnicityEnum ethnicity;
  @override
  final DateTime birthday;

  @override
  String toString() {
    return 'UserProfile(name: $name, gender: $gender, ethnicity: $ethnicity, birthday: $birthday)';
  }
...
abstract class _UserProfile extends UserProfile {
  const factory _UserProfile(
      ...
      required final EthnicityEnum ethnicity,
      required final DateTime birthday}) = _$_UserProfile;
